Public Class Form4
    ...
    Private Sub COMLAB1BindingNavigatorSaveItem_Click(sender As System.Object, e As System.EventArgs)
        ...
        Me.TableAdapterManager.UpdateAll(Me.FUCKTHISSHIT1DataSet1)

    End Sub

    Private Sub Form4_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'FUCKTHISSHIT1DataSet1.COMLAB1' table. You can move, or remove it, as needed.
        ...
        Me.COMLAB1TableAdapter.Fill(Me.FUCKTHISSHIT1DataSet1.COMLAB1)
    ...
    Private Sub Button1_Click(sender As System.Object, e As System.EventArgs) Handles Button1.Click
        Try
            ...
            DATE_ADDEDTextBox.Text = Date.Now.ToShortDateString
            COMLAB1DataGridView.Enabled = False
    ...
    Private Sub Button2_Click(sender As System.Object, e As System.EventArgs) Handles Button2.Click
        Try
            TextBox1.Enabled = True
            COMLAB1DataGridView.Enabled = True
            PRODUCT_CODETextBox.Enabled = False
            MANUFACTURERTextBox.Enabled = False
            PRICETextBox.Enabled = False
            QUANTITYTextBox.Enabled = False
    ...
    Private Sub Button4_Click(sender As System.Object, e As System.EventArgs) Handles Button4.Click
        Try
            ...
            COMLAB1TableAdapter.Update(FUCKTHISSHIT1DataSet1.COMLAB1)
    ...
    Private Sub Button11_Click(sender As System.Object, e As System.EventArgs)
        ...
        If RadioButton4.Checked Then
            Me.COMLAB1BindingSource.Filter = "STATUS like '%" & TextBox1.Text & "%'"
        End If
    End Sub
